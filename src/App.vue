        ...
        <div class="bg-weather-secondary px-12 pt-10 mt-2 rounded">
          <div class="flex gap-6">
            <div class="flex flex-col flex-1 text-center gap-4">
              <span>今天</span><span>07-02</span><span>小雨</span
              ><span>风力1-3级</span>
            </div>
            <div class="flex flex-col flex-1 text-center gap-4">
              <span>明天</span><span>07-03</span><span>小雨</span
              ><span>风力1-3级</span>
            </div>
            <div class="flex flex-col flex-1 text-center gap-4">
              <span>周四</span><span>07-04</span><span>小雨</span
              ><span>风力1-3级</span>
            </div>
            <div class="flex flex-col flex-1 text-center gap-4">
              <span>周五</span><span>07-05</span><span>小雨</span
              ><span>风力1-3级</span>
            </div>
          </div>
